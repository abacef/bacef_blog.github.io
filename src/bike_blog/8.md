...
Tires on a road bike are important, and fascinating. Understanding them can be hard though. Here is a guide to understand them at a high level. Hopefully this takes you from "There is a lot I have questions about" to "I want to geek out more on the details"
...
Here is a table to break these down by performance characteristics (abbreviated from above for readability) (5 is better than 1)

| | TT | RLFT | AS | PP |
| --- | --- | --- | --- | --- |
| Price Range | 4-5 | 4-5 | 3 | 3 |
